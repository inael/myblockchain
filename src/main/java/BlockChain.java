...
public class BlockChain {
    public static void main(String[] args) {
        ...
        Block worldBlock = new Block("BIG", blockChainList.get(blockChainList.size()-1).getHash());
        blockChainList.add(worldBlock);

        Block dZoneBlock = new Block("World", blockChainList.get(blockChainList.size()-1).getHash());
